<template>
  <template v-if="!menu.hideMenu">
    ...
    <app-link v-else-if="showMenuType === 1" :to="pathResolve" v-show="menu.meta.visible">
    ...
    <app-link v-else :to="pathResolve" v-show="menu.meta.visible">
